...
#line hidden
        ...
        public void VerifyLoginForOrangeHrmWebsite(string username, string passwd, string[] exampleTags)
        {
...
#line hidden
#line 8
 testRunner.When(string.Format("User enters the \"{0}\" and \"{1}\" in the text fields", username, passwd), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 9
